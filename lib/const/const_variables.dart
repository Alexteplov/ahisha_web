...
class GlobalVar {
  ...
  static const String nameLibLong =
...
//Библиотека в сети
  static const String libInNet = ' Сайт db74.ru';
  static const String inContact = ' ВКонтакте  ';
  static const String odnoklassniki = 'Одноклассники';
  ...
  static const String logoOdnoklassniki = 'image/odnoklassniki_logo.jpg';
...
//Маршруты роутинга(переходов)
  ...
  static const String routeAfisha = '/afisha_pb';
  /*
...
*/
  ...
  static const String routeLibRules = '/lib_rules';
  ...
  static const String routeOdnoklassniki = '/odnoklassniki_qr';
  ...
  static const String urlVK = 'https://m.vk.com/kids_libraries_che';
  static const String urlOdn = 'https://m.ok.ru/group/70000001191164';
  static const String urlDB = 'http://db74.ru';
